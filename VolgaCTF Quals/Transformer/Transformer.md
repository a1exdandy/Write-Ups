...
анализировать код этой функции. Он достаточно запутанный: наблюдаются большое количество
переходов в середины инструкций и другие методы обфускации. Ручная конвертация данных в код заняла бы достаточно
...
Во второй и третьей строке в регистр `rdi` помещается адрес `0x40167e + 5`,
