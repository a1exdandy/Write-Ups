...
анализировать код этой функции. Он достаточно запутанный: наблюдаются
переходы в середины инструкций и другие методы обфускации. Ручная конвертация данных в код заняла бы достаточно
