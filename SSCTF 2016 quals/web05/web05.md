...
[main_page]: /web05/images/main_page.png "Главная страница"
[alert_msg]: /web05/images/alert_msg.png "Предупреждение"
[login_page]: /web05/images/ligon_page.png "Страница входа"
[reg_success]: /web05/images/reg_succ.png "Успешная регистрация"
[try_login]: /web05/images/login.png "Попытка войти"
[login_success]: /web05/images/login_succ.png "Вход прошел успешно"
[main_page_after_login]: /web05/images/main_page_after_login.png "Главная страница после входа"
[cookies]: /web05/images/cookies.png "Cookies"
[my_info]: /web05/images/my_info.png "Форма пополнения счета"
[user_page]: /web05/images/user_page.png "Страница пользователя"
[add_money_error]: /web05/images/add_money_error.png "Ошибка при пополнении счета"
[try_simple_inj]: /web05/images/inj.png "Попытка вставить простую sql-инъекцию"
[simple_inj_result]: /web05/images/inj_res.png "Результат sql-иъекции"
[form_source]: /web05/images/form_source.png "Исходный код формы пополнения счета"
[salted_form]: /web05/images/salted_form.png "Измененная форма"
[flag_is]: /web05/images/flag_is.png "Флаг"
